...
| --- | --- | --- | --- | 
<<<<<<< HEAD
| 0 | DDD-STR-VISION | DDD-STR-VISION-{{文档版本号}}-00.md | 产品愿景 |
| 1 | DDD-STR-BVC | DDD-STR-BVC-{{文档版本号}}-01.md | 业务价值画布 (Business Value Canvas) |
| 2 | DDD-STR-BCM | DDD-STR-BCM-{{文档版本号}}-02.md | 业务能力地图 (Business Capability Map) |
| 3 | DDD-STR-SDM | DDD-STR-SDM-{{文档版本号}}-03.md | 子域优先级矩阵 (Subdomain Priority Matrix) |
| 4 | DDD-STR-CDS | DDD-STR-CDS-{{文档版本号}}-04.md | 核心域场景说明书 (Core Domain Scenario) |
| 5 | DDD-STR-BCX | DDD-STR-BCX-{{文档版本号}}-05.md | 限界上下文地图 (Bounded Context Map) |
| 6 | DDD-STR-CIT | DDD-STR-CIT-{{文档版本号}}-06.md | 上下文集成表 (Context Integration Table) |
| 7 | DDD-STR-ROADMAP | DDD-STR-ROADMAP-{{文档版本号}}-07.md | Roadmap 演进路线 & 里程碑 |
| 8 | DDD-STR-ESP | DDD-STR-ESP-{{文档版本号}}-08.md | 事件风暴规划 (Event Storming Planning) |
| 9 | DDD-STR-USER-STORIES | DDD-STR-USER-STORIES-{{文档版本号}}-09.md | 用户故事与旅程 |
| 10 | DDD-STR-UX-PROTOTYPES | DDD-STR-UX-PROTOTYPES-{{文档版本号}}-10.md | 低保真界面原型 & 故事板 |
=======
...
flowchart TD
    subgraph A [第一阶段：产品愿景规划]
        direction LR
<<<<<<< HEAD
        A1[DDD-STR-VISION] --> A2[DDD-STR-BVC]
=======
...
>>>>>>> 0140bada383e79ae44a5bc79b580238e3ac5caa5
    ...
    subgraph C [第三阶段：用户故事与旅程规划]
        direction LR
<<<<<<< HEAD
        C1[DDD-STR-USER-STORIES] --> C2[DDD-STR-UX-PROTOTYPES]
=======
