...
- **请求参数**:
  | 参数名 | 类型 | 必填 | 描述 |
  | :--- | :--- | :--- | :--- |
  | action | string | 是 | 操作类型 (mark_processed, export_report) |
  | roomIds | array | 是 | 房间ID列表 |
  | note | string | 否 | 备注信息 |
  | reportPeriod | string | 否 | 报告周期 (today, week, month) - 仅导出时有效 |
  | reportFormat | string | 否 | 报告格式 (excel, pdf) - 仅导出时有效 |

- **响应数据**:
```json
{
  "message": "操作成功",
  "downloadUrl": "http://api.../download/report.xlsx", // 仅导出时返回
  "successCount": 3,
  "failedCount": 0
}
```
...
{
  "id": 1,
  "orderNo": "RO-20251216-001",
  "deviceId": 1,
  "deviceName": "主卧浴室",
  "deviceSn": "SN123456",
  "status": "shipped_back",
  "issueDescription": "无法开机",
  "userLogisticsNo": "SF123456",
  "userLogisticsImage": "http://img...",
  "officialLogisticsNo": "SF654321",
  "officialLogisticsImage": "http://img...",
  "timeline": [
    { "status": "applied", "time": "2025-12-16T10:00:00Z", "text": "用户已提交申请" },
    { "status": "received", "time": "2025-12-17T14:00:00Z", "text": "待运营确认收货" },
    { "status": "repaired", "time": "2025-12-18T09:00:00Z", "text": "维修完成" },
    { "status": "shipped_back", "time": "2025-12-18T16:00:00Z", "text": "维修完成已寄回" }
  ]
}
```
